...
sender_login = "levitinvlad99@gmail.com"  ############# TODO # mail account
sender_password ="rubik123!" ############# TODO
notifier = Notifier(sender_login, sender_password)

#notifier.add_receiver("oganesman8@mail.ru")
notifier.add_receiver("levitinvlad99@gmail.com")
notifier.add_receiver("dosarudaniel@gmail.com")
notifier.add_receiver("ulugbekna@gmail.com")
